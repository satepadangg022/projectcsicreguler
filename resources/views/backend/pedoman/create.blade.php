...
@section('content')
    ...
    <div class="row">
      <div class="col-12">
        ...
        @endif
            <form action="{{route('store.pedoman')}}" method="POST" enctype="multipart/form-data" style="padding-left: 20px; padding-right: 20px;">
                @csrf
                <div class="mb-3">
                  <label for="name" class="form-label">Name</label><br>
                  <input type="text" id="name" name="name" value="{{ old('name') }}" aria-describedby="name" class="form-control form-control-pill">
                </div>
                <div class="mb-3">
                  <label for="type" class="form-label">Penerbit</label><br>
                  <input type="text" id="type" name="type" value="{{ old('type') }}" aria-describedby="type" class="form-control form-control-pill">
                </div>
                <div class="mb-3">
