        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">RFC</h6>
            </div>
          </div>
          ...
          @endif
            <div class="d-flex justify-content-end mb-3" style="margin-right: 30px">
              <a href="{{ route('create.rfc') }}" class="btn btn-sm btn-primary">Tambah</a>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          ...
                          @else
                            <span class="text-danger">PDF tidak tersedia</span>
                          @endif
                        </div>
                      </div>
                    </td>                    
                    ...
                    <td class="align-middle">
                      <a href="{{route('edit.rfc',$d->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit Data">
                        Edit
                      </a>
                      |
                      <a href="{{ route('delete.rfc', $d->id) }}"
